      ...
      <div className="wcy-container py-5  w-full mt-20 px-10 ">
        <div className="inner-cont w-full md:text-center ">
          <div className="smallertex flex md:justify-center">
            <div className="inner-smaller-text text-gray-600 flex bg-gray-100 rounded-full p-3 items-center font-semibold my-2 uppercase text-sm">
              <svg
        ...
        <div className="cardcontainer md:mx-20 ">
          <div className="row-one grid lg:grid-cols-3 md:grid-cols-2 gap-4 ">
            ...
            <div className="stepTwo shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]   py-6 px-3 rounded-xl ">
              <div className="stepHead ">
                <div className="small-text">
                  <div className="cont flex items-center uppercase font-semibold opacity-70 text-xs">
                    <svg
            ...
            <div className="stepThree shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]   py-6 px-3 rounded-xl ">
              <div className="stepHead ">
                <div className="small-text">
                  <div className="cont flex items-center uppercase font-semibold opacity-70 text-xs">
                    <svg
            ...
            <div className="stepFour shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]   py-6 px-3 rounded-xl ">
              <div className="stepHead ">
                <div className="small-text">
                  <div className="cont flex items-center uppercase font-semibold opacity-70 text-xs">
                    <svg
            ...
            <div className="stepFive shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]   py-6 px-3 rounded-xl ">
              <div className="stepHead ">
                <div className="small-text">
                  <div className="cont flex items-center uppercase font-semibold opacity-70 text-xs">
                    <svg
            ...
            <div className="stepSix shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]   py-6 px-3 rounded-xl ">
              <div className="stepHead ">
                <div className="small-text">
                  <div className="cont flex items-center uppercase font-semibold opacity-70 text-xs">
                    <svg
        ...
        <div className="slider-card-sm hidden mt-10">
          <Slider {...settings}>
            <div className="stepOne shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]    py-6 px-3 rounded-xl ">
              <div className="stepHead ">
                <div className="small-text">

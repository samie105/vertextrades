...
import Ttable from "../../../components/admin/TradesTable/Ttable";

export default function TradesTable({ em }) {
  ...
  return (
    <div className="px-4 pt-12">
      <div className="settings px-3 py-4 rounded-md shadow-md shadow-gray-100">
        <div className="profile font-bold">User Trade settings</div>
      ...
      {data && <Ttable data={data} setData={setData} email={email} />}
    </div>
  );
}
